              ...
              <section className="space-y-2">
                ...
                <div className="p-3.5 rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-200 text-xs leading-relaxed space-y-1">
                  <div className="font-semibold flex items-center gap-1.5">
                    <span>⚠</span> IMPORTANT NOTICE ON REMOTE SENSING ACCURACY
                  </div>
                  <p>
              ...
              <section className="space-y-2">
                ...
                {onOpenCookieSettings && (
                  <button
                    ...
                    className="mt-2 px-4 py-2 rounded-xl text-xs font-mono font-semibold text-cyan-400 border border-cyan-400/40 bg-cyan-950/30 hover:bg-cyan-900/40 transition-all cursor-pointer"
                  >
                    ⚙ Open Cookie & Storage Settings
                  </button>
                )}
              </section>
            </div>
